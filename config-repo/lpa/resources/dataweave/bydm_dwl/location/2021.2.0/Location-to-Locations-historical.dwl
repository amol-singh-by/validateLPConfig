...
Locations : {(payload[vars.bulkType] filter($.documentActionCode != "DELETE") map (value)  ->  {
			Record : {
				...
				Latitude: if(value.basicLocation.address.geographicalCoordinates.latitude != null) value.basicLocation.address.geographicalCoordinates.latitude else null,
				Longitude: if(value.basicLocation.address.geographicalCoordinates.longitude != null) value.basicLocation.address.geographicalCoordinates.longitude else null,
				Altitude : null,
