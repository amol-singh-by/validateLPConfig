...
Promotions: {
	(payload map (item, index) -> 
		...
		Record: {
			...
			PromotionFrom: if ( !isEmpty(item."eligibilityInformation.effectiveFromDate") ) item."eligibilityInformation.effectiveFromDate"
          else "",
			PromotionUpTo: if ( !isEmpty(item."eligibilityInformation.effectiveUpToDate") ) item."eligibilityInformation.effectiveUpToDate"
          else "",
