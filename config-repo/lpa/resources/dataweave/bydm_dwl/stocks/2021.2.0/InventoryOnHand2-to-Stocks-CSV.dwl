...
"Stocks": ({
	...
	if ( getOperationType(stocks) == "Record" ) "Record" : {
			...
			ValidDay: if ( stocks.availableForSupplyDate != null ) stocks.availableForSupplyDate else "",
			...
			ExpirationDay: if ( stocks.bestBeforeDate != null and stocks.bestBeforeDate != "" ) stocks.bestBeforeDate else null
		}
	else if ( getOperationType(stocks) == "DeleteRecord" and vars.stocksLazyMode and (stocks.itemId == "*UNKNOWN" or stocks.locationId == "*UNKNOWN")) "DeleteAllRecords": {
