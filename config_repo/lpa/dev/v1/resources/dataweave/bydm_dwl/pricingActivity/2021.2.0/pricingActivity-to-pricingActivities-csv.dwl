...
fun codeListPricingActivityTypeCode(value, codelistFlag) =
  codelistFlag match {
    ...
    else -> if ( (jda::CodeMap::keyLookupWithDefault(vars.codeMap.PricingActivityTypeCode, "PricingActivityTypeCode", value, value)) != null ) jda::CodeMap::keyLookupWithDefault(vars.codeMap.PricingActivityTypeCode, "PricingActivityTypeCode", value, value)
    else value
}
...
"PricingActivities": ({
	...
	if ( getOperationType(pa.documentActionCode) == "Record" ) "Record" : {
			...
			"DeliverPrices" : if(pa."deliverPrices" != null) lower(pa."deliverPrices") else false,
	...
	else if ( getOperationType(pa.documentActionCode) == "DeleteRecord" and pa."pricingActivityId.locationId" == "*UNKNOWN" or pa."pricingActivityId.itemId" == "*UNKNOWN" or pa."pricingActivityId.pricingStrategyTypeCode" == "*UNKNOWN" ) "DeleteAllRecords": {
